...
import {createReservationSchedulePage, createScheduleObjects, createReservationTable, updateTheReservationTables} from '../receptionist/reservation_schedule_functions.js';
...
fetch("../../controller/receptionist/onsiteRe_schedule_controller.php?sportID=".concat(sportID))
    .then(res => res.json())
    .then(data => {
        console.log(data);
