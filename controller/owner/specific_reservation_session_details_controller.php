<?php
    //this script is used to get the details of a specific reservation or a coaching session when the owner clicks on a reserved spot in the reservation schedule page
    session_start();
