<?php
    ...
    class Mailer{
        ...
        public static function changeStaffLoginNotification($recipientEmail,$newEmail=null,$newPwd='',$recipient_name){   //this function is used to send the verification code to the user's email upon registration
