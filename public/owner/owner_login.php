...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-box">
            <form action="/controller/owner/login_controller.php" method="post" id="loginForm">
                <div>   
                    Username : 
                    <input
                    type="text" 
                ...
                <div class = 'success-msg' id="msgbox">
                    <?php
                        if(isset($_SESSION['LogInsuccessMsg'])){
                            ...
                            header("Refresh: 3; URL =/public/owner/owner_dashboard.php");   
                        }
                    ?>
                </div>
    ...
    <script src="/js/owner/owner_login_handle.js"></script>
    <script src="/js/owner/owner_login_validation.js"></script>
</html>